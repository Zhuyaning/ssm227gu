...
public class UserController {
    ...
    public Result resetPass(String username) {
        UserEntity user = userService.selectOne(new EntityWrapper<UserEntity>().eq(USER_NAME, username));
        if (user == null) {
    ...
    public Result update(@RequestBody UserEntity user) {
        UserEntity u = userService.selectOne(new EntityWrapper<UserEntity>().eq(USER_NAME, user.getUsername()));
